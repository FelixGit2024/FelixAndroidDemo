    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv24.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(taskNum=="  1  "){
                    startActivity(new Intent(Activity_Week_2_4.this, Activity_Day_2_2_1.class));
                } else if (taskNum=="  2  ") {
                    startActivity(new Intent(Activity_Week_2_4.this, Activity_Day_2_2_2.class));
                }else if (taskNum=="  3  ") {
                    startActivity(new Intent(Activity_Week_2_4.this, Activity_Day_2_2_3.class));
                }else if (taskNum=="  4  ") {
                    startActivity(new Intent(Activity_Week_2_4.this, Activity_Day_2_2_4.class));
                }
            }
        });
    }
